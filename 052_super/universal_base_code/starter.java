...
class starter {
	public static void main(String args[]) {
		...
		Apprentice apprentice2 = new Apprentice("Harvard", 4);
		Apprentice apprentice3 = new Apprentice("Trumpet", "Yale", 6);
		APprentice apprentice4 = new Apprentice("Ben", "Clarinet", "CVHS", 3);
	}
}
